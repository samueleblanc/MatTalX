...
function replaceLetters(letters: string[], dict: any, initialCommand: string, checkMistakes=true): (string | string[])[] {
...
function mistakes(textInput: string, textOutput: string | undefined, letter=""): string {
    ...
    const popup = <HTMLElement>document.getElementById("mistakes");
