/*
    ...
    What is left here is what Chrome names differently from Firefox.
*/

// Everything that asks about the shortcuts the browser owns goes through this. Chrome
// has the commands API wherever it takes extensions at all, so this is only ever the API
// itself here -- but a popup should not stop half way through setting itself up because
// one API is missing, which is exactly what Firefox for Android does to its own copy
const browserCommands = (chrome.commands) ? chrome.commands : null;
