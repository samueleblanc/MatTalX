...
- {\mathcal abc} should give the same result as \mathcal{abc}
...
<a href="https://github.com/samueleblanc/MatTalX_website" target="_blank">website repository</a> and runs the very same `core.js`. A change to `core.js` opens a pull request there on its own
